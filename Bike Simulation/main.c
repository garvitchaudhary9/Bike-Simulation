...
//  Bike Simulation
//
//  Created by Garvit Chaudhary on 26/09/21.
//
...
bitmap_output(-1.25,1.8,0.50,"DELHI TECHNOLOGICAL UNIVERSITY");
bitmap_output(-0.6,1.6,0.50,"Garvit Chaudhary");
bitmap_output(-0.6,1.4,0.50,"Devender Kumar Pahadia");
